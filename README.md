...
### Kit Resources
Refer to the [kits](https://github.com/renesas/aiot-ready/tree/master/kits) directory to obtain a *Board Support Package (BSP)*, *Quick Setup Example (QSE)* and its accompanying projects for hardware platforms designed to support **Renesas Ready Solutions**. Documentation is available at the root of each folder provides further details on how to use those resources.
### Application Examples 
Refer to the [application_examples](https://github.com/renesas/aiot-ready/tree/master/application_examples) directory to obtain a *Board Support Package (BSP)*, *Quick Setup Example (QSE)* and its accompanying projects for hardware platforms designed to support **Renesas Ready Solutions**. Documentation is available at the root of each folder provides further details on how to use those resources.
## References
